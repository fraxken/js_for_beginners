 ...
 * 
 * @desc
 * Afficher un message en fonction de la valeur d'une variable (avec des conditions if / else).
 * 
 ...
 * 
 * @see
 * Il est aussi possible de développer une solution plus "courte" avec les "ternaires". Essayez !
 * - https://developer.mozilla.org/fr/docs/Web/JavaScript/Reference/Op%C3%A9rateurs/L_op%C3%A9rateur_conditionnel
 */

// --> valeurRandom sera aléatoirement "vrai" ou "faux". !! NE PAS MODIFIER !!
